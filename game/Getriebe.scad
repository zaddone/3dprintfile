...
module pfeilrad(modul=0.5, zahnzahl=0, breite=0, bohrung=0, eingriffswinkel = 20, schraegungswinkel=0, optimiert=false){
            ...
            for(n=[0:1:anzahl_planeten-1]){
                translate(kugel_zu_kart([achsabstand,90,360/anzahl_planeten*n]))
					rotate([0,0,n*360*d_sonne/d_planet])
						pfeilrad (modul, zahnzahl_planet, breite, bohrung, eingriffswinkel, schraegungswinkel,optimiert);	// Planetenräder
            }
       }
       else{
            achsabstand = modul*(zahnzahl_sonne + zahnzahl_planet)/2;		// Abstand von Sonnenrad-/Hohlradachse
...
//pfeilhohlrad (modul=1, zahnzahl=30, breite=5, randbreite=3, eingriffswinkel=20, schraegungswinkel=30);
 ...
 planetengetriebe(modul=0.5, zahnzahl_sonne=11, zahnzahl_planet=25, anzahl_planeten=3, breite=6, randbreite=2, bohrung=0, eingriffswinkel=20, schraegungswinkel=0, zusammen_gebaut=true, optimiert=false);
